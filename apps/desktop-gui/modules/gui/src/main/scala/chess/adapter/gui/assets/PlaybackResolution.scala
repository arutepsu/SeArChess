...
/** The fully-resolved playback output for a single animation frame.
  ...
  *   asset key of the sprite-sheet segment that should be displayed on this frame (e.g.
  *   `"classic/white_knight_attack1"`)
  * @param frameIndex
  *   zero-based frame index within that segment's sprite sheet
  */
