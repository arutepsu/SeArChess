...
/** ScalaFX notation sidebar widget.
  *
  * Builds the visual component tree from a list of [[NotationActionDescriptor]]s and wires user
  * interactions to [[NotationSidebarController.handle]]. Widget state is reflected from
  * [[NotationSidebarState]] via [[refresh]].
  *
  * Layout:
  ...
  *
  * Adding a new notation action requires only registering a new [[NotationActionDescriptor]] — no
  * change to this widget is needed.
  *
  * Responsibilities:
  ...
  *
  * @param controller
  *   the controller that owns sidebar state and routing
  * @param descriptors
  *   the notation actions to render, in display order; defaults to
