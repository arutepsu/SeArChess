...
/** Feedback message displayed inside the notation sidebar after an import or export operation.
  *
  * Owned exclusively by the sidebar's local state. GUI callers present this without needing
  * notation-layer error types.
  */
...
object SidebarFeedback:
  ...
  /** The last operation failed.
    *
    * @param message
    *   primary human-readable description
    * @param details
    *   optional supplementary detail (e.g. location in the input)
    * @param category
    *   coarse category for presentation decisions
    */
