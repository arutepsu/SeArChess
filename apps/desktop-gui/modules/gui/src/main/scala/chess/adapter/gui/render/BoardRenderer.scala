...
object BoardRenderer:
  ...
  /** @param suppressPos
    *   when [[Some]], the piece on that square is not rendered — kept for API compatibility with
    *   animation refresh flow. The board layer itself no longer renders pieces.
    */
  def update(
      grid: GridPane,
      vm: GameViewModel,
