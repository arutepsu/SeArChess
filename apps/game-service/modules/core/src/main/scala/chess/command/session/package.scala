/** Application use cases that mutate session state.
  ...
  *
  * Not yet populated — session lifecycle is not modelled in the current codebase. This package is a
  * forward boundary for when multi-session or networked play is introduced.
  */
