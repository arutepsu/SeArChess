...
/** Tests focused on [[SessionService.getSessionByGameId]], the method added for the Phase 7 REST
  * adapter.
  *
  * Other [[SessionService]] methods are exercised transitively by the REST mapper and route
