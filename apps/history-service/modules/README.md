...
| Module | Role |
|---|---|
| `core` | Game event ingestion, Redis Streams consumer, Game archive HTTP client, archive materialization, and History-owned Postgres/Slick archive persistence. |
