...
class PersistenceBoundarySpec extends AnyFlatSpec with Matchers:
  ...
  private def scalaMainFiles: List[Path] =
    val sourceRoots = List(
      root.resolve("backend/services/game-service/src/main/scala"),
      root.resolve("backend/services/game-service/modules/core/src/main/scala"),
      root.resolve("backend/services/game-service/modules/migration/src/main/scala"),
      root.resolve("backend/services/game-service/modules/persistence/src/main/scala")
    )
