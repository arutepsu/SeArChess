...
This document complements backend/services/game-service/README.md. The README describes game-service as the runtime composition root; this document defines the architectural contracts and responsibility boundaries of the game-service subsystem.
