...
/** Presentation-layer policy for horizontal sprite facing on the static board.
  *
  * Sprites are authored facing right. With the board in horizontal orientation (White on the left,
  * Black on the right) Black pieces must be mirrored so they face their opponent.
  *
