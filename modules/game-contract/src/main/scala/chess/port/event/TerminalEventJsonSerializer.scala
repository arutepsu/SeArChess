...
/** Port for serialising terminal [[AppEvent]]s to their JSON wire representation before writing
  ...
  * adapter imports.
  *
  * [[NoOpTerminalEventJsonSerializer]] always returns [[None]] and is the correct implementation
  * for in-memory persistence and GUI/TUI modes where no durable outbox is configured. It is the
  * default in all service constructors.
  */
