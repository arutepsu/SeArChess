 ...
 *
 *  This is intentionally not a REST DTO. It represents the session facts that
 *  inbound adapters may query without exposing the internal [[GameSession]]
 *  aggregate as the long-term process boundary contract.
 */
