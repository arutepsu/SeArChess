 ...
 *
 *  Both variants wrap the underlying [[chess.notation.api.NotationFailure]]
 *  message as a string so that callers do not need a dependency on the
 *  notation module to handle them.
 *
