...
class SpriteCatalogParserSpec extends AnyFlatSpec with Matchers:
  ...
  /** Minimal valid clip specs covering all 5 visual states (for full
   *  branch coverage of the state parser). */
  ...
  private def singleCatalog(
      ...
      playbackVal: String = """{"state": "Move", "mode": "Clamp", "segments": ["classic/white_pawn_move"]}"""
  ): String =
  ...
  it should "return the theme string from the JSON" in {
    val catalog = SpriteCatalogParser.parse(fullCatalog()).toOption.get
    catalog.theme shouldBe "classic"
  }

  it should "inline the clipSpec into each SpriteSheetEntry" in {
    val catalog = SpriteCatalogParser.parse(singleCatalog()).toOption.get
  ...
  it should "parse displaySize when present" in {
    ...
    val catalog = SpriteCatalogParser.parse(json).toOption.get
  ...
  it should "return ParseError for invalid JSON" in {
    ...
    result.left.toOption.get.head shouldBe a[CatalogValidationError.ParseError]
  }
  ...
  it should "return MissingSection for a non-object root" in {
    ...
    result shouldBe a[Left[_, _]]
    result.left.toOption.get.head shouldBe CatalogValidationError.MissingSection("root object")
  }

  it should "return MissingSection for missing theme" in {
    val json = """{"clipSpecs": {}, "spriteSheets": {}, "statePlayback": {}}"""
    val err  = SpriteCatalogParser.parse(json).left.toOption.get.head
    err shouldBe a[CatalogValidationError.MissingSection]
    err.asInstanceOf[CatalogValidationError.MissingSection].section should include("theme")
  }

  it should "return MissingSection for an empty theme string" in {
    val err = SpriteCatalogParser.parse(fullCatalog(theme = """""""")).left.toOption.get.head
    err shouldBe a[CatalogValidationError.MissingSection]
    err.asInstanceOf[CatalogValidationError.MissingSection].section should include("empty")
  }

  it should "return MissingSection for a non-string theme" in {
    val err = SpriteCatalogParser.parse(fullCatalog(theme = "42")).left.toOption.get.head
    err shouldBe a[CatalogValidationError.MissingSection]
    err.asInstanceOf[CatalogValidationError.MissingSection].section should include("not a string")
  }
  ...
  it should "return MissingSection for missing clipSpecs section" in {
    ...
    val err  = SpriteCatalogParser.parse(json).left.toOption.get.head
    err shouldBe a[CatalogValidationError.MissingSection]
    err.asInstanceOf[CatalogValidationError.MissingSection].section should include("clipSpecs")
  }
  ...
  it should "return MissingSection when clipSpecs is not an object" in {
    ...
    val err  = SpriteCatalogParser.parse(json).left.toOption.get.head
    err shouldBe a[CatalogValidationError.MissingSection]
    err.asInstanceOf[CatalogValidationError.MissingSection].section should include("not an object")
  }
  ...
  it should "return MissingSection for missing spriteSheets section" in {
    ...
    val err  = SpriteCatalogParser.parse(json).left.toOption.get.head
    err shouldBe a[CatalogValidationError.MissingSection]
    err.asInstanceOf[CatalogValidationError.MissingSection].section should include("spriteSheets")
  }
  ...
  it should "return MissingSection for missing statePlayback section" in {
    ...
    val err  = SpriteCatalogParser.parse(json).left.toOption.get.head
    err shouldBe a[CatalogValidationError.MissingSection]
    err.asInstanceOf[CatalogValidationError.MissingSection].section should include("statePlayback")
  }
  ...
  it should "return InvalidClipSpec when the entry is not an object" in {
    val err = SpriteCatalogParser.parse(singleCatalog(clipVal = "42")).left.toOption.get.head
  ...
  it should "return InvalidClipSpec for frameCount = 0" in {
    ...
    err shouldBe a[CatalogValidationError.InvalidClipSpec]
    err.asInstanceOf[CatalogValidationError.InvalidClipSpec].reason should include("frameCount")
  }
  ...
  it should "return InvalidClipSpec for missing frameCount" in {
    ...
    err shouldBe a[CatalogValidationError.InvalidClipSpec]
    err.asInstanceOf[CatalogValidationError.InvalidClipSpec].reason should include("missing frameCount")
  }

  it should "return InvalidClipSpec for frameCount that is not a number" in {
    val err = SpriteCatalogParser.parse(
      singleCatalog(clipVal = """{"frameCount": "four", "frameSize": {"width": 64, "height": 64}}""")
    ).left.toOption.get.head
    err shouldBe a[CatalogValidationError.InvalidClipSpec]
    err.asInstanceOf[CatalogValidationError.InvalidClipSpec].reason should include("not a number")
  }
  ...
  it should "return InvalidClipSpec for missing frameSize" in {
    ...
    err shouldBe a[CatalogValidationError.InvalidClipSpec]
    err.asInstanceOf[CatalogValidationError.InvalidClipSpec].reason should include("missing frameSize")
  }
  ...
  it should "return InvalidClipSpec when frameSize is not an object" in {
    ...
    err shouldBe a[CatalogValidationError.InvalidClipSpec]
    err.asInstanceOf[CatalogValidationError.InvalidClipSpec].reason should include("frameSize is not an object")
  }
  ...
  it should "return InvalidClipSpec for frameSize width = 0" in {
    ...
    err shouldBe a[CatalogValidationError.InvalidClipSpec]
    err.asInstanceOf[CatalogValidationError.InvalidClipSpec].reason should include("width")
  }
  ...
  it should "return InvalidClipSpec for frameSize height = 0" in {
    ...
    err shouldBe a[CatalogValidationError.InvalidClipSpec]
    err.asInstanceOf[CatalogValidationError.InvalidClipSpec].reason should include("height")
  }

  it should "return InvalidClipSpec when displaySize width <= 0" in {
    val err = SpriteCatalogParser.parse(
      singleCatalog(clipVal = """{"frameCount": 4, "frameSize": {"width": 64, "height": 64}, "displaySize": {"width": 0.0, "height": 80.0}}""")
    ).left.toOption.get.head
    err shouldBe a[CatalogValidationError.InvalidClipSpec]
  }
  ...
  it should "return InvalidClipSpec when displaySize height <= 0" in {
    val err = SpriteCatalogParser.parse(
      singleCatalog(clipVal = """{"frameCount": 4, "frameSize": {"width": 64, "height": 64}, "displaySize": {"width": 80.0, "height": 0.0}}""")
    ).left.toOption.get.head
    err shouldBe a[CatalogValidationError.InvalidClipSpec]
  }
  ...
  it should "return InvalidClipSpec when displaySize is not an object" in {
    val err = SpriteCatalogParser.parse(
      singleCatalog(clipVal = """{"frameCount": 4, "frameSize": {"width": 64, "height": 64}, "displaySize": 80}""")
    ).left.toOption.get.head
    err shouldBe a[CatalogValidationError.InvalidClipSpec]
  }
  ...
  it should "return InvalidClipSpec when anchor is not an object" in {
    val err = SpriteCatalogParser.parse(
      singleCatalog(clipVal = """{"frameCount": 4, "frameSize": {"width": 64, "height": 64}, "anchor": "center"}""")
    ).left.toOption.get.head
    err shouldBe a[CatalogValidationError.InvalidClipSpec]
  }
  ...
  it should "return InvalidClipSpec when anchor x is not a number" in {
    val err = SpriteCatalogParser.parse(
      singleCatalog(clipVal = """{"frameCount": 4, "frameSize": {"width": 64, "height": 64}, "anchor": {"x": "half", "y": 0.0}}""")
    ).left.toOption.get.head
    err shouldBe a[CatalogValidationError.InvalidClipSpec]
  }
  ...
  it should "return InvalidClipSpec when anchor y is not a number" in {
    val err = SpriteCatalogParser.parse(
      singleCatalog(clipVal = """{"frameCount": 4, "frameSize": {"width": 64, "height": 64}, "anchor": {"x": 0.5, "y": "half"}}""")
    ).left.toOption.get.head
    err shouldBe a[CatalogValidationError.InvalidClipSpec]
  }
  ...
  it should "return InvalidSpriteSheet when the entry is not an object" in {
    val err = SpriteCatalogParser.parse(singleCatalog(sheetVal = "42")).left.toOption.get.head
  ...
  it should "return InvalidSpriteSheet for an empty path" in {
    ...
    err shouldBe a[CatalogValidationError.InvalidSpriteSheet]
    err.asInstanceOf[CatalogValidationError.InvalidSpriteSheet].reason should include("path")
  }
  ...
  it should "return InvalidSpriteSheet when path is not a string" in {
    ...
    err shouldBe a[CatalogValidationError.InvalidSpriteSheet]
    err.asInstanceOf[CatalogValidationError.InvalidSpriteSheet].reason should include("not a string")
  }
  ...
  it should "return InvalidSpriteSheet for a missing clipSpec field" in {
    ...
    err shouldBe a[CatalogValidationError.InvalidSpriteSheet]
    err.asInstanceOf[CatalogValidationError.InvalidSpriteSheet].reason should include("clipSpec")
  }
  ...
  it should "return InvalidSpriteSheet when clipSpec key references a non-existent clip" in {
    ...
    err shouldBe a[CatalogValidationError.InvalidSpriteSheet]
    err.asInstanceOf[CatalogValidationError.InvalidSpriteSheet].reason should include("nonexistent")
  }

  // ── statePlayback validation errors ──────────────────────────────────────

  it should "return InvalidStatePlayback when the entry is not an object" in {
    val err = SpriteCatalogParser.parse(singleCatalog(playbackVal = "42")).left.toOption.get.head
  ...
  it should "return InvalidStatePlayback for a missing state field" in {
    val err = SpriteCatalogParser.parse(
      singleCatalog(playbackVal = """{"mode": "Clamp", "segments": ["classic/white_pawn_move"]}""")
    ).left.toOption.get.head
    err shouldBe a[CatalogValidationError.InvalidStatePlayback]
    err.asInstanceOf[CatalogValidationError.InvalidStatePlayback].reason should include("state")
  }

  it should "return InvalidStatePlayback for an empty state string" in {
    val err = SpriteCatalogParser.parse(
      singleCatalog(playbackVal = """{"state": "", "mode": "Clamp", "segments": ["classic/white_pawn_move"]}""")
    ).left.toOption.get.head
    err shouldBe a[CatalogValidationError.InvalidStatePlayback]
    err.asInstanceOf[CatalogValidationError.InvalidStatePlayback].reason should include("state")
  }
  ...
  it should "return InvalidStatePlayback when state is not a string" in {
    val err = SpriteCatalogParser.parse(
      singleCatalog(playbackVal = """{"state": 5, "mode": "Clamp", "segments": ["classic/white_pawn_move"]}""")
    ).left.toOption.get.head
    err shouldBe a[CatalogValidationError.InvalidStatePlayback]
  }
  ...
  it should "return InvalidStatePlayback for an empty mode string" in {
    val err = SpriteCatalogParser.parse(
      singleCatalog(playbackVal = """{"state": "Move", "mode": "", "segments": ["classic/white_pawn_move"]}""")
    ).left.toOption.get.head
    err shouldBe a[CatalogValidationError.InvalidStatePlayback]
    err.asInstanceOf[CatalogValidationError.InvalidStatePlayback].reason should include("mode")
  }

  it should "return InvalidStatePlayback when mode is not a string" in {
    val err = SpriteCatalogParser.parse(
      singleCatalog(playbackVal = """{"state": "Move", "mode": 1, "segments": ["classic/white_pawn_move"]}""")
    ).left.toOption.get.head
    err shouldBe a[CatalogValidationError.InvalidStatePlayback]
  }
  ...
  it should "return InvalidStatePlayback for an unknown state string" in {
    val err = SpriteCatalogParser.parse(
      singleCatalog(playbackVal = """{"state": "Fly", "mode": "Clamp", "segments": ["classic/white_pawn_move"]}""")
    ).left.toOption.get.head
    err shouldBe a[CatalogValidationError.InvalidStatePlayback]
    err.asInstanceOf[CatalogValidationError.InvalidStatePlayback].reason should include("Fly")
  }

  it should "return InvalidStatePlayback for a missing mode field" in {
    val err = SpriteCatalogParser.parse(
      singleCatalog(playbackVal = """{"state": "Move", "segments": ["classic/white_pawn_move"]}""")
    ).left.toOption.get.head
    err shouldBe a[CatalogValidationError.InvalidStatePlayback]
    err.asInstanceOf[CatalogValidationError.InvalidStatePlayback].reason should include("mode")
  }
  ...
  it should "return InvalidStatePlayback for an unknown mode string" in {
    val err = SpriteCatalogParser.parse(
      singleCatalog(playbackVal = """{"state": "Move", "mode": "Bounce", "segments": ["classic/white_pawn_move"]}""")
    ).left.toOption.get.head
    err shouldBe a[CatalogValidationError.InvalidStatePlayback]
    err.asInstanceOf[CatalogValidationError.InvalidStatePlayback].reason should include("Bounce")
  }
  ...
  it should "return InvalidStatePlayback for missing segments" in {
    ...
    err shouldBe a[CatalogValidationError.InvalidStatePlayback]
    err.asInstanceOf[CatalogValidationError.InvalidStatePlayback].reason should include("segments")
  }
  ...
  it should "return InvalidStatePlayback for an empty segments array" in {
    ...
    err shouldBe a[CatalogValidationError.InvalidStatePlayback]
    err.asInstanceOf[CatalogValidationError.InvalidStatePlayback].reason should include("non-empty")
  }

  it should "return InvalidStatePlayback when segments is not an array" in {
    val err = SpriteCatalogParser.parse(
      singleCatalog(playbackVal = """{"state": "Move", "mode": "Clamp", "segments": "classic/white_pawn_move"}""")
    ).left.toOption.get.head
    err shouldBe a[CatalogValidationError.InvalidStatePlayback]
    err.asInstanceOf[CatalogValidationError.InvalidStatePlayback].reason should include("not an array")
  }
  ...
  it should "return InvalidStatePlayback when a segment entry is not a string" in {
    ...
    err shouldBe a[CatalogValidationError.InvalidStatePlayback]
    err.asInstanceOf[CatalogValidationError.InvalidStatePlayback].reason should include("not a string")
  }

  it should "return InvalidStatePlayback when a segment key is absent from spriteSheets" in {
    val err = SpriteCatalogParser.parse(
      singleCatalog(playbackVal = """{"state": "Move", "mode": "Clamp", "segments": ["classic/nonexistent"]}""")
    ).left.toOption.get.head
    err shouldBe a[CatalogValidationError.InvalidStatePlayback]
    err.asInstanceOf[CatalogValidationError.InvalidStatePlayback].reason should include("nonexistent")
  }
